function createDishes() {
  ...
  dishes.appendChild(
    createDish(
      "Arugula Rolls",
      "Fresh arugula, bathing in spicy sauce and resting in a tortilla wrap",
      150,
      67,
    ),
  );
  dishes.appendChild(
    createDish(
      ...
      "The flavour of the mountain, contained in a single drink!",
      128,
      57,
    ),
  );
  dishes.appendChild(
    createDish(
      "Cherry Berry Shakey",
      "A sweet cherry-rich drink beloved by both kids and adults!",
      128,
      57,
    ),
  );
